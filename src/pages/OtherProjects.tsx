      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl border border-gray-200 shadow-sm hover:shadow-xl transition duration-500 p-10">
          ...
          <p className="text-gray-600 leading-relaxed mb-8 max-w-4xl">
            Sikhistory is an educational web platform dedicated to presenting
            Sikh history in a structured, accessible, and modern format.
            The platform emphasizes clean UI architecture, responsive layouts,
            and optimized performance to ensure smooth user experience across
            devices.
          </p>
...
<div className="flex justify-center mt-10">
  <a
    href="https://sikhistory1.netlify.app"
    target="_blank"
